...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { _: "/Users/usuario/Downloads/CatalogoAstro/catalog-astro/node_modules/.bin/astro" })?.PROD) {
...
export { createRenderInstruction as $, AstroError as A, encoder as B, chunkToByteArray as C, chunkToString as D, EndpointDidNotReturnAResponse as E, chunkToByteArrayOrString as F, toAttributeString as G, markHTMLString as H, renderSlotToString as I, maybeRenderHead as J, containsServerDirective as K, Fragment as L, MissingMediaQueryDirective as M, NoMatchingImport as N, OnlyResponseCanBeReturned as O, renderSlot as P, renderSlots as Q, ROUTE_TYPE_HEADER as R, ServerIslandComponent as S, createAstroComponentInstance as T, Renderer as U, NoMatchingRenderer as V, formatList as W, NoClientOnlyHint as X, internalSpreadAttributes as Y, voidElementNames as Z, renderTemplate as _, REROUTE_DIRECTIVE_HEADER as a, findRouteToRewrite as a$, renderElement as a0, SlotString as a1, mergeSlotInstructions as a2, HTMLString as a3, isHTMLString as a4, isRenderInstruction as a5, isAstroComponentInstance as a6, isRenderInstance as a7, renderCspContent as a8, isNode as a9, ForbiddenRewrite as aA, copyRequest as aB, ASTRO_GENERATOR as aC, getOriginPathname as aD, LocalsReassigned as aE, generateCspDigest as aF, PrerenderClientAddressNotAvailable as aG, ClientAddressNotAvailable as aH, StaticClientAddressNotAvailable as aI, REWRITE_DIRECTIVE_HEADER_KEY as aJ, REWRITE_DIRECTIVE_HEADER_VALUE as aK, AstroResponseHeadersReassigned as aL, responseSentSymbol as aM, prependForwardSlash as aN, collapseDuplicateLeadingSlashes as aO, joinPaths as aP, isInternalPath as aQ, collapseDuplicateTrailingSlashes as aR, hasFileExtension as aS, LocalsNotAnObject as aT, routeHasHtmlExtension as aU, clientAddressSymbol as aV, fileExtension as aW, slash as aX, routeIsRedirect as aY, routeIsFallback as aZ, getFallbackRoute as a_, isDeno as aa, addAttribute as ab, MiddlewareNoDataOrNextCalled as ac, MiddlewareNotAResponse as ad, CacheNotEnabled as ae, defineMiddleware as af, NOOP_MIDDLEWARE_HEADER as ag, decryptString as ah, createSlotValueFromString as ai, DEFAULT_404_COMPONENT as aj, DEFAULT_404_ROUTE as ak, default404Instance as al, decodeKey as am, RouteCache as an, sequence as ao, ReservedSlotName as ap, getRouteGenerator as aq, isRoute404 as ar, isRoute500 as as, removeLeadingForwardSlash as at, SessionStorageInitError as au, SessionStorageSaveError as av, getParams as aw, collapseDuplicateSlashes as ax, setOriginPathname as ay, getProps as az, appendForwardSlash as b, isRemotePath as b0, NoImageMetadata as b1, FailedToFetchRemoteImageDimensions as b2, RemoteImageNotAllowed as b3, ExpectedImage as b4, LocalImageUsedWrongly as b5, MissingImageDimension as b6, UnsupportedImageFormat as b7, IncompatibleDescriptorOptions as b8, UnsupportedImageConversion as b9, InvalidImageService as ba, ExpectedImageOptions as bb, ExpectedNotESMImage as bc, ImageMissingAlt as bd, FontFamilyNotFound as be, unescapeHTML as bf, renderHead as bg, InvalidComponentArgs as bh, MissingSharp as bi, ResponseSentError as c, ActionNotFoundError as d, ActionError as e, deserializeActionResult as f, ACTION_RPC_ROUTE_PATTERN as g, ACTION_QUERY_PARAMS as h, i18nNoLocaleFoundInPath as i, actionResultErrorStack as j, ActionInputError as k, REDIRECT_STATUS_CODES as l, ActionsReturnedInvalidDataError as m, getActionQueryString as n, REROUTABLE_STATUS_CODES as o, pipelineSymbol as p, isPropagatingHint as q, removeTrailingForwardSlash as r, shouldAppendForwardSlash as s, getPropagationHint as t, escapeHTML as u, bufferPropagatedHead as v, isHeadAndContent as w, isRenderTemplateResult as x, isPromise as y, promiseWithResolvers as z };
