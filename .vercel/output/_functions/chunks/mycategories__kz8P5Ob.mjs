...
import { X, Tags, FolderPlus, Plus, Pencil, Trash2, Search } from 'lucide-react';
...
import styled$1, { internal_serializeStyles, internal_mutateStyles, keyframes } from '@mui/styled-engine';
...
function useField(initialValue = "", options = {}) {
...
function CategoryFormModal({
  ...
  const categoryName = useField("", {
    ...
    required: true,
    className: "h-12 w-full rounded-2xl border border-[#D9E1DE] bg-[#FAFBFA] px-4 text-sm text-[#2F3433] outline-none transition placeholder:text-[#A0AAA6] focus:border-[#AFC4BD] focus:ring-2 focus:ring-[#DCE7E2]"
  });
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-xl rounded-[28px] bg-white px-5 py-6 shadow-[0_20px_40px_rgba(0,0,0,0.08)] sm:px-6", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: CloseModal,
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#E8F3EF]", children: /* @__PURE__ */ jsx(Tags, { className: "h-6 w-6 text-[#0F6C74]" }) }),
      /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-[#7E8C87]", children: "Administración" }),
      /* @__PURE__ */ jsx("h3", { className: "mt-2 text-xl font-medium text-[#2F3433] sm:text-2xl", children: "Añadir nueva categoría" })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleFormSubmit, className: "flex flex-col gap-4", children: [
...
function CategoriesAdminList({
  ...
  if (!categories || categories.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "rounded-[28px] bg-white/80 px-6 py-12 text-center shadow-[0_10px_30px_rgba(0,0,0,0.04)]", children: /* @__PURE__ */ jsx("p", { className: "text-lg text-[#5F6A66]", children: "No hay categorías registradas." }) });
  }
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-5", children: categories.map((category) => /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-lg font-medium leading-snug text-[#2F3433] sm:text-xl", children: category.name }),
            /* @__PURE__ */ jsxs("p", { className: "mt-2 text-sm uppercase tracking-[0.14em] text-[#7E8C87]", children: [
    ...
    isOpenModalDelete && /* @__PURE__ */ jsx(
      ConfirmationModal,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("p", { className: "text-base font-medium text-[#2F3433]", children: "¿Eliminar esta categoría?" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-[#6B7773]", children: "Esta acción es irreversible." })
        ] })
      }
    )
  ] });
...
function EditCategoryProductsModal({
  categoryId,
  isOpen,
  CloseModal,
  onSave
  ...
  const fetchData = async (id) => {
    try {
      ...
      const withSelection = allProducts.map(
        (product) => ({
          product,
  ...
  const filteredProducts = products.filter(({ product }) => {
    ...
    return product.nameProduct.toLowerCase().includes(search) || product.brand.toLowerCase().includes(search);
  });
  ...
  const toggleProductSelection = (idProduct) => {
    setProducts(
      (prev) => prev.map(
        (entry) => entry.product.idProduct === idProduct ? { ...entry, selected: !entry.selected } : entry
      )
    );
  };
  if (!isOpen) return null;
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-[28px] bg-white px-5 py-6 shadow-[0_20px_40px_rgba(0,0,0,0.08)] sm:px-6", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: CloseModal,
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#E8F3EF]", children: /* @__PURE__ */ jsx(Tags, { className: "h-6 w-6 text-[#0F6C74]" }) }),
      /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-[#7E8C87]", children: "Categoría" }),
      /* @__PURE__ */ jsx("h3", { className: "mt-2 text-xl font-medium text-[#2F3433] sm:text-2xl", children: category?.name }),
      /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm leading-6 text-[#6B7773]", children: "Selecciona los productos que pertenecerán a esta categoría." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(Search, { className: "pointer-events-none absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#8A8883]" })
    ] }) }),
    /* @__PURE__ */ jsxs("ul", { className: "space-y-3", children: [
      paginatedProducts.length === 0 && /* @__PURE__ */ jsx("li", { className: "rounded-2xl bg-[#FAFBFA] px-4 py-6 text-center text-sm text-[#6B7773]", children: "No se encontraron productos." }),
      paginatedProducts.map(({ product, selected }) => /* @__PURE__ */ jsxs(
        "li",
        {
          className: "flex items-center justify-between rounded-2xl border border-[#EEF2F0] bg-[#FAFBFA] px-4 py-3",
          children: [
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsx("p", { className: "font-medium text-[#2F3433]", children: product.nameProduct }),
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-[#7E8C87]", children: product.brand })
            ] }),
            /* @__PURE__ */ jsx(
              Checkbox,
              {
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [
      totalPages > 1 ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxs("span", { className: "text-sm text-[#6B7773]", children: [
          "Página ",
          page,
          " de ",
          totalPages
...
function CategoriesSection() {
  ...
  const handleOnDelete = async (categoryId) => {
    try {
  ...
  const handleOnEdit = (categoryId) => {
    setCategoryEdit(categoryId);
  };
  const handleOnSave = async (products) => {
    if (!categoryEdit) return;
    try {
      const productIds = products.filter(({ selected }) => selected).map(({ product }) => product.idProduct);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsx("div", { className: "mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: /* @__PURE__ */ jsx(AddCategoriesButton, { onSubmit: handleOnSubmit }) }),
    /* @__PURE__ */ jsx(
      CategoriesAdminList,
      {
        categories,
...
const $$Mycategories = createComponent(($$result, $$props, $$slots) => {
...
</h1> ${renderComponent($$result2, "CategoriesSection", CategoriesSection, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/admin/categories/CategoriesSection", "client:component-export": "default" })} </div> ` })}`;
}, "/Users/usuario/Downloads/CatalogoAstro/catalog-astro/src/pages/admin/mycategories.astro", void 0);

const $$file = "/Users/usuario/Downloads/CatalogoAstro/catalog-astro/src/pages/admin/mycategories.astro";
const $$url = "/admin/mycategories";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$Mycategories,
  file: $$file,
  url: $$url
